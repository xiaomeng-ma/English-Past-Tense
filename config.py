...
def get_args():
    ...
    ##data path
    parser.add_argument('-data_path_train', type=str, default='/home-nfs/lygao/project/tense/English-Past-Tense-master'
                                                              '/Data/Training/Train_type_reg.csv',
                        help='training data path')
    parser.add_argument('-data_path_test', type=str, default='/home-nfs/lygao/project/tense/English-Past-Tense-master'
                                                             '/Data/Test/Test.csv', help='test data path')
    parser.add_argument('-data_path_nonce', type=str, default='/home-nfs/lygao/project/tense/English-Past-Tense-master'
                                                              '/Data/Test/Nonce.csv', help='nonce data path')
    ##data label
    parser.add_argument('-label_spec', type=str, default='reg', choices=['reg', 'vc', 'both', 'no'],
                        help='reg: regularity, vc: verb class, both: both, no: no label')
    ##dataset type
    parser.add_argument('-set_type', type=str, default='no', choices=['no', 'equal'],
                        help='to have equal size reg and irreg in train')
    ##EPOCHS
    ...
    parser.add_argument('-dff', type=int, default=512, metavar='N',
...
def process_args(args):
    suffix_dir = str(args.seed) + '_' + str(args.vk) + '_' + \
                 args.label_spec + '_' + args.data_path_train.split('/')[-1]
