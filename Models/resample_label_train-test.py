...
if __name__ == "__main__":
    ...
    df_train, df_test, df_nonce, t, MAX_LEN = equal_data_process.tokenize(args)
    epoch_train_dataset, val_dataset, test_dataset, nonce_dataset = equal_data_process.process_data(
        args, df_train, df_test, df_nonce, t, MAX_LEN)
    #num_batches, val_batches = len(epoch_train_dataset[0]), len(val_dataset)
    ...
    if ckpt_manager.latest_checkpoint:
        ...
        for epoch in range(EPOCHS):
            ...
            train_dataset = epoch_train_dataset[epoch]
